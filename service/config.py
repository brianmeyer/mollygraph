...
MOLLYGRAPH_TRAIN_REBALANCE_ENABLED = os.environ.get("MOLLYGRAPH_TRAIN_REBALANCE_ENABLED", "true").lower() == "true"
MOLLYGRAPH_TRAIN_REBALANCE_WORKSAT_CAP = int(os.environ.get("MOLLYGRAPH_TRAIN_REBALANCE_WORKSAT_CAP", "1200"))
MOLLYGRAPH_TRAIN_REBALANCE_MAX_RATIO = float(os.environ.get("MOLLYGRAPH_TRAIN_REBALANCE_MAX_RATIO", "0.35"))
MOLLYGRAPH_TRAIN_REBALANCE_TARGET_LABELS = os.environ.get(
    "MOLLYGRAPH_TRAIN_REBALANCE_TARGET_LABELS",
    "CLASSMATE_OF,STUDIED_AT,LOCATED_IN,CONTACT_OF,MEMBER_OF",
)
MOLLYGRAPH_TRAIN_REBALANCE_TARGET_MIN = int(os.environ.get("MOLLYGRAPH_TRAIN_REBALANCE_TARGET_MIN", "250"))
MOLLYGRAPH_TRAIN_REBALANCE_TARGET_MULTIPLIERS = os.environ.get(
    "MOLLYGRAPH_TRAIN_REBALANCE_TARGET_MULTIPLIERS",
    "CLASSMATE_OF:3.0,STUDIED_AT:2.0,LOCATED_IN:1.5,CONTACT_OF:1.5,MEMBER_OF:1.5",
)
...
# Maximum number of relationships the LLM audit may auto-delete per run when
...
AUDIT_AUTO_DELETE_PCT = float(os.environ.get("MOLLYGRAPH_AUDIT_AUTO_DELETE_PCT", "0.05"))  # 5% of reviewed
